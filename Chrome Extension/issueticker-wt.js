function ajaxissue(url, data, rawtx) {
    ...
    xhr.onreadystatechange = function () {
        if (xhr.readyState == 4) {
            ...
            $("#issuefromwallet").html("<div class='h2' style='padding: 60px 0 30px 0;'>Token Issued!</div><div class='h4'>Token will appear in wallet after one confirmation</div><div class='h3' style='padding: 30px 0 30px 0;'><a href='https://chain.so/tx/BTC/"+newTxid+"' target='_blank'>View Transaction</a></div><div class='h3' style='padding: 0 0 30px 0;'><a href='http://xcp.ninja/p2p/seed.html?bvamhash="+hash+"' target='_blank'>Start Seeding BVAM</a></div>");
...
$( document ).ready(function() {   
        ...
        if (datafromurl["address"][0] !== "undefined" && datafromurl["divisible"][0] !== "undefined" && datafromurl["asset"][0] !== "undefined" && datafromurl["description"][0] !== "undefined" && datafromurl["amount"][0] !== "undefined") {
            ...
            $("#content").html("<div class='row'><div class='col-xs-3' style='text-align: right; font-weight: bold;'>Issuing Address:</div><div class='col-xs-9' style='text-align: left;'>"+address+"</div></div><div class='row'><div class='col-xs-3' style='text-align: right; font-weight: bold;'>Asset ID:</div><div class='col-xs-9' style='text-align: left;'>"+asset+"</div></div><div class='row'><div class='col-xs-3' style='text-align: right; font-weight: bold;'>Divisible:</div><div class='col-xs-9' style='text-align: left;'>"+divisible+"</div></div><div class='row'><div class='col-xs-3' style='text-align: right; font-weight: bold;'>Amount to be Issued:</div><div class='col-xs-9' style='text-align: left;'>"+amount+"</div></div><div class='row'><div class='col-xs-3' style='text-align: right; font-weight: bold;'>Description:</div><div class='col-xs-9' style='text-align: left;'>"+description+"</div></div><div class='row'><div class='col-xs-3' style='text-align: right; font-weight: bold;'>BVAM json:</div><div class='col-xs-9' style='text-align: left;' id='bvamjson'>Loading...</div></div><div class='row'><div class='col-xs-3' style='text-align: right; font-weight: bold;'>BVAM link:</div><div class='col-xs-9' style='text-align: left;' id='bvamlink'>Loading...</div></div><div class='row'><div class='col-xs-3' style='text-align: right; font-weight: bold;'>Webtorrent Magnet link:</div><div class='col-xs-9' style='text-align: left;' id='magnetlink'>Loading...</div></div>");
            
            var hash = description.substr(7);
            
            $("body").data({hash: hash});
            
            var filename_base58_decode = Crypto.util.bytesToHex(Bitcoin.Base58.decode(hash));
            
            console.log(filename_base58_decode);
            
            var success = false;
            
            var bvamlink = "http://xcp.ninja/p2p/infohash/"+filename_base58_decode+"/BVAMWT.json";
            
            var magnetUri = 'magnet:?xt=urn:btih:'+filename_base58_decode;
            ...
            $.getJSON(bvamlink, function(data) {
                ...
                $("#magnetlink").html("<a href='"+magnetUri+"' target='_blank'>"+magnetUri+"</a>"); 
